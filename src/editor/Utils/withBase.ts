import "../constants/elementsConst";
...
export interface BaseEditorCustom {
  isSelectionExpanded: () => boolean;
  isSelectionCollapsed: () => boolean;
  isFocused: () => boolean;
  unwrapNode: (type: string) => void;
  isNodeTypeActive: (type: string) => boolean;
  rememberedSelection: Partial<Selection>;
  rememberCurrentSelection: () => void;
  isCollapsed: () => boolean | null;
  wrapNode: (node: Node, wrapSelection: Selection) => void;
}

const withBase = (editor: CustomEditorType) => {
  /**
